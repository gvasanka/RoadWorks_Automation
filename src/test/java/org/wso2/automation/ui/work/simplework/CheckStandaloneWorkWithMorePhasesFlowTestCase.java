...
/**
 * The following test case checks the lifecycle of the Standalone Work With More Phases
 */

public class CheckStandaloneWorkWithMorePhasesFlowTestCase extends RoadWorksUIBaseTest {
    ...
    public void testWithdrawFromalStandalone(){
        workHomePage.checkWorkSearchTableLoad();
