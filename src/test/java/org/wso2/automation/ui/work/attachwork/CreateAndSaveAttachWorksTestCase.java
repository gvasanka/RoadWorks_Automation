...
public class CreateAndSaveAttachWorksTestCase extends RoadWorksUIBaseTest {
    ...
    public void testWithdrawSavedAttacheWorks(){
        workHomePage.checkWorkSearchTableLoad();
        updateWorkPage = workHomePage.viewMatchingWork(ATTACHWORK,SUB_TYPE_SAVE);
        ...
        Assert.assertTrue(workHomePage.isMatchingTextAvailableInCell(matchingWorks.get(0),"Provisional"));
    }
