...
public class CreateAndSubmitFormalAttachWorksTestCase extends RoadWorksUIBaseTest {
    ...
    public void testCreateAndSaveAttacheWorks(){
        ...
        workHomePage =new CreateWorkPage(driver,uiElementMapper,user).doSubmitFormal();
    }

    @Test(dependsOnMethods ="testCreateAndSaveAttacheWorks")
    public void testWithdrawFormalAttacheWorks(){
        workHomePage.checkWorkSearchTableLoad();
        updateWorkPage = workHomePage.viewMatchingWork(ATTACHWORK,SUB_TYPE_FORMAL);
