...
import static org.wso2.automation.ui.utils.data.AppConstants.ATTACHWORK;
...
public class EditAndSaveAttachWorksTestCase extends RoadWorksUIBaseTest {
    ...
    public void testEditAndSaveAttachWork(){
        ...
        Assert.assertTrue(workHomePage.isMatchingTextAvailableInCell(matchingWorks.get(0),ATTACHWORK));

        workHomePage.viewMatchingWork(largeWorkTestData.notificationTitle,SUB_TYPE_SAVE);

        workTypeAttachedWorksPage =new WorkTypeAttachedWorksPage(driver,uiElementMapper,user);
        workTypeAttachedWorksPage.fillParentSchemeNumber("N1600850");
    ...
    @Test(dependsOnMethods = "testEditAndSaveAttachWork")
    public void verifyUpdateAttachWork() {
        workHomePage.checkWorkSearchTableLoad();
        workHomePage.viewMatchingWork(largeWorkTestData.notificationTitle,SUB_TYPE_SAVE);

        workTypeAttachedWorksPage =new WorkTypeAttachedWorksPage(driver,uiElementMapper,user);

        workTypeAttachedWorksPage.loadPromoterDetailsForm().verifySchemePromoterDetailsForm(
                largeWorkTestData.promoter,
                largeWorkTestData.contactName,
                largeWorkTestData.contactAddress,
                largeWorkTestData.contactPositions,
        ...
        workTypeAttachedWorksPage.loadSchemeSummaryForm().verifySchemeSummaryForm(
                largeWorkTestData.notificationTitle,
                largeWorkTestData.proposalClient,
                largeWorkTestData.promoterRef,
                largeWorkTestData.bspRef,
        ...
        workTypeAttachedWorksPage.loadDetailForm().verifyDetailsForm(
                largeWorkTestData.startDate,
                largeWorkTestData.endDate,
                largeWorkTestData.locationUSRN,
                largeWorkTestData.locationDetails,
        ...
        workTypeAttachedWorksPage.loadPhasesForm().verifyAddNewPhase(
                largeWorkTestData.tmStart,
                largeWorkTestData.tmEnd,
                largeWorkTestData.tfcMgt,
                largeWorkTestData.restrictions,
