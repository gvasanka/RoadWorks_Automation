...
public class CreateAndProvisionAttachWorksTestCase extends RoadWorksUIBaseTest {
    ...
    public void testWithdrawProvisionedAttacheWorks(){
        workHomePage.checkWorkSearchTableLoad();
        updateWorkPage = workHomePage.viewMatchingWork(ATTACHWORK,SUB_TYPE_PROVISIONAL);
