 ...
 */
public class CheckSchemeFlowTestCase extends RoadWorksUIBaseTest {
    ...
    public void testSubmitProvisionalScheme(){
    ...
    @Test(dependsOnMethods ="testSubmitProvisionalScheme")
    public void testSubmitFormalScheme(){
        workHomePage.checkWorkSearchTableLoad();
