...
/**
 * The following test case checks the submit formal of a Scheme
 */
public class CreateAndSubmitFormalSchemeTestCase extends RoadWorksUIBaseTest {
    ...
    public void testWithdrawFormalScheme(){
        ...
        updateWorkPage = workHomePage.viewMatchingWork(SCHEME,SUB_TYPE_FORMAL);
